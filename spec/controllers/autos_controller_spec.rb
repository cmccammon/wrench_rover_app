...
RSpec.describe AutosController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      auto = Auto.create! valid_attributes
      get :show, params: {id: auto.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      auto = Auto.create! valid_attributes
      get :edit, params: {id: auto.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Auto" do
        expect {
          post :create, params: {auto: valid_attributes}, session: valid_session
